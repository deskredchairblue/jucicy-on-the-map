...
const validateConfig = () => {
    const requiredEnvVars = [
        { key: 'JWT_SECRET', value: exports.config.JWT_SECRET, default: true },
        { key: 'JWT_REFRESH_SECRET', value: exports.config.JWT_REFRESH_SECRET, default: true },
    ];
    if (process.env.NODE_ENV === 'production') {
        requiredEnvVars.push({ key: 'MONGODB_URI', value: exports.config.MONGODB_URI, default: false }, { key: 'STRIPE_SECRET_KEY', value: exports.config.STRIPE_SECRET_KEY, default: false }, { key: 'STRIPE_WEBHOOK_SECRET', value: exports.config.STRIPE_WEBHOOK_SECRET, default: false });
    }
    const missingEnvVars = requiredEnvVars.filter((envVar) => !envVar.value || (envVar.default && process.env.NODE_ENV === 'production'));
